...
extern eat_bool simcom_atcmd_queue_fun_append(AtCmdEntity* atCmdEntity,u8 funCount);
...
extern eat_bool simcom_atcmd_queue_fun_set(u8 count);
...
extern eat_bool simcom_sms_msg_send(u8* number, u8* msg, u16 msgLen,ResultNotifyCb pResultCb);
...
extern void simcom_atcmd_queue_default_cb_set(ResultNotifyCb callback);
