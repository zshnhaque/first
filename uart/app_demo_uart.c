...
static const EatUart_enum eat_uart_debug = EAT_UART_NULL;
...
#if 0
    if( eat_gpio_read(EAT_PIN24_COL4) == EAT_GPIO_LEVEL_LOW)
        eat_int_setup(EAT_PIN24_COL4, EAT_INT_TRIGGER_HIGH_LEVEL, 10, EAT_NULL);
    else
