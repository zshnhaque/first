...
void app_func_ext1(void *data)
{
	...
	*/
    ...
    eat_pin_set_mode(EAT_PIN24_COL4, EAT_PIN_MODE_EINT);
    eat_pin_set_mode(EAT_PIN26_PWM, EAT_PIN_MODE_EINT);
    eat_pin_set_mode(EAT_PIN69_UART1_DTR, EAT_PIN_MODE_EINT); 
    eat_pin_set_mode(EAT_PIN54_SIM_PRE, EAT_PIN_MODE_EINT); 
...
eat_bool eat_module_test_eint(u8 param1, u8 param2)
{
    /***************************************
     * example 1
     * EAT_PIN45_GPIO3 interrupt used callback
     ***************************************/
    ...
    if( 1 == param1 )
    {
        ...
        if( 1 == param2 )
        {
           ...
           //eat_int_setup(EAT_PIN24_COL4, EAT_INT_TRIGGER_LOW_LEVEL, 10, test_handler_int_level);
           //eat_int_setup(EAT_PIN69_UART1_DTR, EAT_INT_TRIGGER_LOW_LEVEL, 10, test_handler_int_level);
           
           eat_trace("EINT test 1,1 start");
           eat_trace("System will interrupt  TRIGGER_LOW_LEVEL");
        }else if( 2 == param2)
        {                   
           eat_int_setup(EAT_PIN26_PWM, EAT_INT_TRIGGER_FALLING_EDGE, 10, test_handler_int_edge);
           //eat_int_setup(EAT_PIN24_COL4, EAT_INT_TRIGGER_FALLING_EDGE, 10, test_handler_int_edge);
           //eat_int_setup(EAT_PIN69_UART1_DTR, EAT_INT_TRIGGER_FALLING_EDGE, 10, test_handler_int_edge);
    ...
    /***************************************
     * example 2
     * EAT_PIN45_GPIO3 interrupt used EVENT
     ***************************************/
    else if( 2 == param1 )
    {
        if( 1 == param2)
        {
           ...
           if( EAT_GPIO_LEVEL_LOW == eat_gpio_read(EAT_PIN26_PWM)) 
           {   
               eat_int_setup(EAT_PIN26_PWM, EAT_INT_TRIGGER_HIGH_LEVEL, 10, NULL);
           }
           else
           {
               eat_int_setup(EAT_PIN26_PWM, EAT_INT_TRIGGER_LOW_LEVEL, 10, NULL);
           }

           if( EAT_GPIO_LEVEL_LOW == eat_gpio_read(EAT_PIN54_SIM_PRE)) 
           {
               eat_trace("EINT PIN%d HIGH LEVEL int test start", EAT_PIN54_SIM_PRE);
               eat_int_setup(EAT_PIN54_SIM_PRE, EAT_INT_TRIGGER_HIGH_LEVEL, 10, NULL);
           }else
           {
               eat_trace("EINT PIN%d LOW LEVEL int test start", EAT_PIN54_SIM_PRE);
               eat_int_setup(EAT_PIN54_SIM_PRE, EAT_INT_TRIGGER_LOW_LEVEL, 10, NULL);
           }
           //eat_int_setup(EAT_PIN24_COL4, EAT_INT_TRIGGER_LOW_LEVEL, 10, NULL);
           //eat_int_setup(EAT_PIN69_UART1_DTR, EAT_INT_TRIGGER_LOW_LEVEL, 10, NULL);
           
           eat_trace("EINT test 2,1 start");
           eat_trace("System will interrupt by  TRIGGER_LOW_LEVEL");
        }else
        {
           eat_int_setup(EAT_PIN26_PWM, EAT_INT_TRIGGER_RISING_EDGE, 10, NULL);
...
void app_user1(void *data)
{
    ...
    //eat_int_setup(EAT_PIN24_COL4, EAT_INT_TRIGGER_LOW_LEVEL, 10, test_handler_int_level);
    //eat_int_setup(EAT_PIN24_COL4, EAT_INT_TRIGGER_LOW_LEVEL, 10, EAT_NULL);
